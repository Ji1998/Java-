...
*/
    ...
    if (args.length > 1){
        System.out.println("WRONG, only single parameter is allowed ! ");
        return;
    }
     System.out.println("Welcome to the On Line Therapy System Guangsen Ji @2020");
