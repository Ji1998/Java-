//ECE492-Guangsen Ji-lab5
// this lab is to build a client able to save and retrieve
//private messages that is sent when the receiver is not online at that time
import java.io.*;
import java.net.*;
import java.awt.*;
...
public class Lab5SaveMessagesChatClient implements ActionListener
{
	public static void main(String[] args)
	{
		...
		try {
			...
			{
				System.out.println("Guangsen Ji :Provide three command line parameters to specify "
